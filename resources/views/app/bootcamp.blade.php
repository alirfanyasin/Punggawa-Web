@extends('layouts.app')
@section('title', env('APP_NAME') . ' - Bootcamp')
@section('content')
  {{-- Breadcrumb start --}}
  <div class="flex justify-between breadcrumb">
    <h3 class="font-semibold lg:text-2xl xs:text-md md:text-xl">Bootcamp</h3>
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="/contest-followed"
              class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Bootcamp</a>
          </div>
        </li>
      </ol>
    </nav>
  ...
  @push('js-custom')
    <script>
      ...
      var btnProgress = document.querySelector('#btn-progress');
      ...
      btnAll.addEventListener('click', function(e) {
        ...
        btnProgress.classList.remove('bg-slate-200')
